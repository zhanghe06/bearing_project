...
DOCUMENT_INFO = {
    ...
    'COMPANY_ADDRESS_EN': 'Room 1024 Level 10, No.100, East Yan\'an Road, Huangpu District, Shanghai, P. R. China',
    # 公司地址英文
    'COMPANY_ADDRESS_CN': _('Room 1024 Level 10, No.100, East Yan\'an Road, Huangpu District, Shanghai, P. R. China'),
    # 公司地址中文
...
MAIL_DEBUG = DEBUG
MAIL_USERNAME = None
MAIL_PASSWORD = None  # 部分邮箱如163，这里是客户端授权码（需要开通），并非邮箱登录密码
